...
```{r}
# These patients are excluded from the efficiency analysis set 
vt_efficiency_analyses_exclusions <- c(
  "1-001", # Procedural failure, excluded from efficiency analysis set
  "1-011", # Procedural failure, excluded from efficiency analysis set
